                ...
                if (connection === "open") {
                   // await Gifted.groupAcceptInvite("GiD4BYjebncLvhr0J2SHAg");
                    ...
                    while (attempts < maxAttempts && !sessionData) {
                        // Same issue as the pairing-code flow: file size isn't proof
                        // pairing finished. `me` (the WhatsApp identity) only appears
                        // once WhatsApp confirms registration. Check the live creds
                        // object instead of the on-disk file size.
